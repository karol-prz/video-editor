...
abstract class GlDynamicOverlayFilter : GlDynamicFilter(DEFAULT_VERTEX_SHADER, FRAGMENT_SHADER) {

    private val textures = IntArray(1)

    private var bitmap: Bitmap? = null

    protected var inputResolution = Size(1080, 1800)
    ...
    override fun onDraw(presentationTime: Long) {
        if (bitmap == null) {
            createBitmap()
        }
    ...
    protected abstract fun drawCanvas(canvas: Canvas, time: Long)
