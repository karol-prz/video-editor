package com.kpchuck.videoeditor.extractor
...
class AudioExtractor {
    ...
    fun genVideoUsingMuxer(
        srcPath: String,
        dstOutputStream: FileOutputStream,
        startMs: Int,
        endMs: Int,
        useAudio: Boolean,
        useVideo: Boolean
        ...
        val muxer = MediaMuxer(dstOutputStream.fd, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4)
